    ...
    public class SendFunctionTest
    {
        ...
        public async Task PendingSendNotificationTest()
        {
            ...
            this.notificationService
                .Setup(x => x.UpdateSentNotification(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        public async Task SendNotificationWhenNoConversationIdTest()
        {
            ...
            this.notificationService.Verify(x => x.UpdateSentNotification(It.Is<string>(x => x.Equals("notificationId")), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once);
        }
        ...
        public async Task SendNotificationSuccess_Test()
        {
            ...
            this.notificationService.Setup(x => x.UpdateSentNotification(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>())).Returns(Task.CompletedTask);
